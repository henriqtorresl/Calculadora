...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		GridBagLayout layout = new GridBagLayout(); // GridBagLayout -> gerenciador de layout disponibilizado pelo swing
		GridBagConstraints c = new GridBagConstraints(); // para que eu possa criar botões de tamanhos variados
	...
	private void adicionarBotao(String texto, Color cor, GridBagConstraints c, int x, int y) {
		c.gridx = x; // posição do botao (gridy = linha e gridx = coluna)
		c.gridy = y;
		Botao botao = new Botao(texto, cor);
		botao.addActionListener(this); // this diz respeito a classe Teclado
		add(botao, c);
	}
